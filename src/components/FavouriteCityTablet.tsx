                ...
                <>
                    <div className='flex items-center gap-2'>
                        ...
                        <div>
                            ...
                            <p className='font-xs text-muted-foreground'> {weather.sys.country} </p>
                        </div>
                    </div>
                    <div className='ml-auto text-right'>
                        <p className='text-xl font-bold'>{Math.round(weather.main.temp)}°</p>
                        <p className='text-xs capiatlize text-muted-foreground'>{weather.weather[0].description}</p>
                    </div>
                </>
            ) : null}
        </div>
...
export default FavouriteCityTablet